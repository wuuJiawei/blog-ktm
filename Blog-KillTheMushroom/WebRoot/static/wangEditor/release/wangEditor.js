...
Editor.prototype = {
    ...
    _initDom: function _initDom() {
        ...
        var areaHeight = config$$1.areaHeight;//武佳伟，允许自行配置的文本区域高度
        ...
        if (textSelector == null) {
            ...
            $textContainerElem.css('border', '1px solid #ccc').css('border-top', 'none').css('height', areaHeight);
        } else {
